...
class EditBiologyQuestionScreen extends StatefulWidget {
  const EditBiologyQuestionScreen({Key? key}) : super(key: key);
  static String namedRoute = "/edit-biology-question";

  @override
  _EditBiologyQuestionScreenState createState() => _EditBiologyQuestionScreenState();
}

class _EditBiologyQuestionScreenState extends State<EditBiologyQuestionScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (questionId != null) {
        ...
        _editedQuestion =
            Provider.of<BiologyQuestions>(context).findById(questionId.toString());
        _initValues = {
