...
class EditChemistryQuestionScreen extends StatefulWidget {
  const EditChemistryQuestionScreen({Key? key}) : super(key: key);
  static String namedRoute = "/edit-chemistry-question";

  @override
  _EditChemistryQuestionScreenState createState() => _EditChemistryQuestionScreenState();
}

class _EditChemistryQuestionScreenState extends State<EditChemistryQuestionScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (questionId != null) {
        ...
        _editedQuestion =
            Provider.of<ChemistryQuestions>(context).findById(questionId.toString());
        _initValues = {
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedQuestion.id == null) {
      ...
      try {
        await Provider.of<ChemistryQuestions>(context, listen: false)
