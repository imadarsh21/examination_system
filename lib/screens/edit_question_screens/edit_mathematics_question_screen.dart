...
class EditMathematicsQuestionScreen extends StatefulWidget {
  const EditMathematicsQuestionScreen({Key? key}) : super(key: key);
  static String namedRoute = "/edit-mathematics-question";

  @override
  _EditMathematicsQuestionScreenState createState() => _EditMathematicsQuestionScreenState();
}

class _EditMathematicsQuestionScreenState extends State<EditMathematicsQuestionScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (questionId != null) {
        ...
        _editedQuestion =
            Provider.of<MathematicsQuestions>(context).findById(questionId.toString());
        _initValues = {
